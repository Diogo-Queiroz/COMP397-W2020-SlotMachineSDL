...
BetButton::BetButton(int value, GameItemType type, std::string stringType)
	:Button("../Assets/texture/slot-" + stringType + "-" + std::to_string(value) + ".png",
		"btnBetValue" + std::to_string(value),
